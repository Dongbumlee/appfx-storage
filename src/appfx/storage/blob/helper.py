...
class StorageBlobHelper:
    ...
    def upload_blob(
        ...
        blob_tier: StandardBlobTier | None = None,
    ) -> bool:
        """
    ...
    def list_blobs_hierarchical(
        self, container_name: str, prefix: str | None = None, delimiter: str = "/"
    ) -> dict[str, Any]:
        """
    ...
    def create_snapshot(
        ...
        try:
            ...
            if not isinstance(snapshot_id, str):
                raise RuntimeError("Azure response did not include a snapshot id")
            return snapshot_id
        except Exception as e:
        ...
        try:
            ...
            for blob in all_blobs:
                ...
                # Search in metadata if requested
                    ...
                    for _key, value in blob["metadata"].items():
            ...
            for root, _dirs, files in os.walk(local_directory):
                for file in files:
                    ...
                    try:
                        ...
                        errors.append(f"Error processing {relative_path}: {e!s}")
