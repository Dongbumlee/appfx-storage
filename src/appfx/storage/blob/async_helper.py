...
import aiofiles  # type: ignore[import-untyped]  # aiofiles does not ship typed stubs.
...
class AsyncStorageBlobHelper:
                ...
                async with semaphore:
                    try:
                        ...
                        success = await self.download_blob_to_file(
                            container_name=container_name,
                            blob_name=blob_name,
                            destination_file_path=str(local_file_path),
                        )
    ...
    async def _get_account_key(self) -> str | None:
    ...
    async def _get_account_name(self) -> str | None:
